...
abstract class BaseStundeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'start_anlage_id' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'start_anlage_id' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'end_anlage_id'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Anlage'), 'column' => 'id')),
  ...
  public function getFields()
  {
    return array(
      ...
      'description'     => 'Text',
      'zim_id'          => 'ForeignKey',
      'start_anlage_id' => 'Number',
      'end_anlage_id'   => 'ForeignKey',
      'created_at'      => 'Date',
      'updated_at'      => 'Date',
    );
  }

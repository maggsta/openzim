...
/**
 * Anhang form base class.
 *
 * @method Anhang getObject() Returns the current form's model object
 *
 * @package    openZIM
 * @subpackage form
 ...
 */
abstract class BaseAnhangForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'Anhang', 'column' => array('path')))
    );

    $this->widgetSchema->setNameFormat('anhang[%s]');

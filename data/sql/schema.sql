...
CREATE TABLE anlage (id INTEGER PRIMARY KEY AUTOINCREMENT, longname VARCHAR(255), kuerzel VARCHAR(255) NOT NULL, zeit INTEGER, ziel VARCHAR(1000), methode VARCHAR(1000), material VARCHAR(1000), tip VARCHAR(1000), kurzinhalt VARCHAR(1000), inhalt VARCHAR(100000), kofferinfo VARCHAR(10000), rolle_tm VARCHAR(1000), stunde_id INTEGER, lnr INTEGER NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL);

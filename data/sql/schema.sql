CREATE TABLE anhang (id INTEGER PRIMARY KEY AUTOINCREMENT, path VARCHAR(255) NOT NULL UNIQUE, caption VARCHAR(255), anlage_id INTEGER NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL);
CREATE TABLE anlage (id INTEGER PRIMARY KEY AUTOINCREMENT, kuerzel VARCHAR(255) NOT NULL, zeit INTEGER, ziel VARCHAR(1000), methode VARCHAR(1000), material VARCHAR(1000), tip VARCHAR(1000), kurzinhalt VARCHAR(1000), inhalt VARCHAR(10000), rolle_tm VARCHAR(1000), stunde_id INTEGER NOT NULL, lnr INTEGER NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL);
CREATE TABLE bild (id INTEGER PRIMARY KEY AUTOINCREMENT, lnr INTEGER NOT NULL, path VARCHAR(255) NOT NULL, caption VARCHAR(1000), anlage_id INTEGER NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL);
...
CREATE TABLE zim (id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL);
...
CREATE UNIQUE INDEX kuerzel_lnr_idx ON anlage (kuerzel, lnr);

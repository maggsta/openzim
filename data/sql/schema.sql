...
CREATE TABLE bild (id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, caption VARCHAR(1000), section_id INTEGER NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL);
